                ...
                <div class="">
                    <svg id="Logo" xmlns="http://www.w3.org/2000/svg" class="w-56" viewBox="0 0 216.136 23.415"
                        ...
                        <rect id="Rectangle_1" data-name="Rectangle 1" width="7.657" height="23.413"
                              transform="translate(157.972 0)" fill="#fff" data-v-58b23701=""></rect>
                        <path id="Path_1" data-name="Path 1"
                              d="M723.98,256.757v.006h0v1.422h6.834v21.983h7.361V258.185h6.811v-1.428Z"
                              transform="translate(-528.847 -256.757)" fill="#fff" data-v-58b23701=""></path>
                        <path id="Path_2" data-name="Path 2"
                              ...
                              transform="translate(-296.886 -256.769)" fill="#fff" data-v-58b23701=""></path>
                        <path id="Path_3" data-name="Path 3"
                              ...
                              transform="translate(-115.116 -256.771)" fill="#fff" data-v-58b23701=""></path>
                        <path id="Path_4" data-name="Path 4"
                              ...
                              transform="translate(-179.909 -256.771)" fill="#fff" data-v-58b23701=""></path>
                        <path id="Path_5" data-name="Path 5"
                              ...
                              transform="translate(-347.059 -256.757)" fill="#fff" data-v-58b23701=""></path>
                        <path id="Path_6" data-name="Path 6"
                              ...
                              transform="translate(-45.841 -256.771)" fill="#fff" data-v-58b23701=""></path>
                        <path id="Path_7" data-name="Path 7"
                              ...
                              transform="translate(-228.796 -256.771)" fill="#fff" data-v-58b23701=""></path>
                        <path id="Path_8" data-name="Path 8"
                              ...
                              transform="translate(-462.587 -256.771)" fill="#fff" data-v-58b23701=""></path>
                    </svg>
                </div>
                <div class=" ">
                    ...
                    <div class="my-4">
                        ...
                        <input class="text-black" type="email" required id="email" v-model="email">
                    </div>
                    <div class="mb-8">
                        <label for="password">Password</label>
                        <input type="password" class="text-black" required id="password" v-model="password">
                    </div>
