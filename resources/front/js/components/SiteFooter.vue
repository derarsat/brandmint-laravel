                    ...
                    <router-link to="/">
                        <svg id="Logo" xmlns="http://www.w3.org/2000/svg" style="width: 240px"
                            ...
                            <path id="Path_5" data-name="Path 5"
                                  ...
                                  transform="translate(-347.059 -256.757)" fill="#fff"/>
                            <path id="Path_6" data-name="Path 6"
                                  d="M45.841,256.777v1.074h2.241v22.331H64.037a11.669,11.669,0,0,0,3.815-.77,9.444,9.444,0,0,0,1.405-.752,5.189,5.189,0,0,0,1.236-1.1A5.414,5.414,0,0,0,71.366,276a5.977,5.977,0,0,0,.333-2.072,4.542,4.542,0,0,0-.785-2.728,6.586,6.586,0,0,0-1.956-1.789,9.724,9.724,0,0,0-2.527-1.052,23.589,23.589,0,0,0-2.526-.518v-.1a3.381,3.381,0,0,0,.52-.15,9.794,9.794,0,0,0,1.086-.452,10.6,10.6,0,0,0,1.338-.768,7.064,7.064,0,0,0,1.305-1.12,6.37,6.37,0,0,0,1-1.455,4.013,4.013,0,0,0,.4-1.806,4.27,4.27,0,0,0-.318-1.7,4.6,4.6,0,0,0-.82-1.291,4.653,4.653,0,0,0-1.138-.919,10.311,10.311,0,0,0-1.3-.635,12.533,12.533,0,0,0-3.581-.668H45.841Zm11.775.974s2.853-.137,4.066,1.545a4.315,4.315,0,0,1,.751,2.7v.739a4.586,4.586,0,0,1-.268,1.637,3.753,3.753,0,0,1-.7,1.156,4.179,4.179,0,0,1-1.02.885,7.064,7.064,0,0,1-1.17.587,8.524,8.524,0,0,1-3.145.6h-.366l-.023-9.847Zm5.654,18.17a5.651,5.651,0,0,1-.7,1.487,4.609,4.609,0,0,1-1,1.07s-.935.885-4.214.885H55.741V268h1.64q.035,0,.5.035a7.067,7.067,0,0,1,1.155.2,8.294,8.294,0,0,1,1.471.531,4.98,4.98,0,0,1,1.455.985,5.479,5.479,0,0,1,1.12,1.689,6.1,6.1,0,0,1,.452,2.49A6.72,6.72,0,0,1,63.269,275.921Z"
                                  transform="translate(-45.841 -256.771)" fill="#fff"/>
                            <path id="Path_7" data-name="Path 7"
                                  d="M326.512,256.777h-.518V271.13l-10.839-12.048a9.143,9.143,0,0,0-1.941-1.32,12.965,12.965,0,0,0-1.675-.683,6.624,6.624,0,0,0-1.605-.3h-7.226v.267a4.956,4.956,0,0,1,1.138.537,11.869,11.869,0,0,1,1.22.8,14.973,14.973,0,0,1,1.457,1.239l.954.981v19.581h.035v0h.932v0h.462V262.118l15.881,17.229a2.256,2.256,0,0,0,1.973.835h.2v0h.452v0h0V256.777h-.9Z"
                                  transform="translate(-228.796 -256.771)" fill="#fff"/>
                            <path id="Path_8" data-name="Path 8"
                                  d="M654.753,256.777h-.52V271.13l-10.841-12.048a7.79,7.79,0,0,0-1.94-1.32,12.738,12.738,0,0,0-1.673-.683,5.206,5.206,0,0,0-1.6-.3h-7.227v.267a4.983,4.983,0,0,1,1.136.537,12.116,12.116,0,0,1,1.22.8,14.5,14.5,0,0,1,1.455,1.239l.957.981v19.581h.036v0h.93v0h.462V262.118l15.883,17.229a2.252,2.252,0,0,0,1.973.835h.2v0h.452v0h0V256.777h-.9Z"
                                  transform="translate(-462.587 -256.771)" fill="#fff"/>
                        </svg>
                    </router-link>
                    <p class="text-sm my-12"> Award winning branding, design & <br> communication agency.</p>
                    <div class="flex gap-2 flex-col">
                        <div class="flex items-center gap-4">
                            <svg id="ic_mail" xmlns="http://www.w3.org/2000/svg" width="15.719" height="10.286"
                                 viewBox="0 0 15.719 10.286">
                                <path id="Fill_1" data-name="Fill 1"
                                      d="M14.6,10.286H1.123A1.1,1.1,0,0,1,0,9.2V1.083A1.1,1.1,0,0,1,1.123,0H14.6a1.1,1.1,0,0,1,1.123,1.083V9.2A1.1,1.1,0,0,1,14.6,10.286ZM2.246,1.624a.57.57,0,0,0-.439.2.529.529,0,0,0,.087.761L7.508,6.926a.583.583,0,0,0,.7,0l5.614-4.339a.532.532,0,0,0,.207-.365.526.526,0,0,0-.12-.4.577.577,0,0,0-.789-.084L7.86,5.81,2.6,1.742A.567.567,0,0,0,2.246,1.624Z"
                                      fill="#00b180"></path>
                            </svg>
                            <a class="" href="mailto:info@brandmint.com">info@brandmint.com</a>
                        </div>
                        <div class="flex items-center gap-4">
                            <svg id="ic_phone" xmlns="http://www.w3.org/2000/svg" width="15.677" height="15.677"
                                 viewBox="0 0 15.677 15.677">
                                <path id="Fill_1" data-name="Fill 1"
                                      d="M7.072,8.6C4.341,5.874,4.731,5.484,4.731,5.484L5.9,4.313a1.1,1.1,0,0,0,0-1.56L3.474.325A1.1,1.1,0,0,0,1.968.273,5.744,5.744,0,0,0,.049,3.143c-.39,1.95,1.561,4.681,4.681,7.8s5.852,5.071,7.8,4.681a5.744,5.744,0,0,0,2.87-1.919,1.1,1.1,0,0,0-.052-1.506L12.923,9.775a1.1,1.1,0,0,0-1.56,0l-1.17,1.171s-.39.39-3.121-2.341"
                                      fill="#00b180"></path>
                            </svg>
                            <div class="flex items-center gap-4">
                                <a class="" href="tel:+96101748204"> +96101748204</a>
                                <span class="">/</span>
                                <a class="" href="tel:+96101748205"> +96101748205</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col gap-4 ">
                    <h1 class="text-2xl font-medium w-full mb-12">Useful links</h1>
                    <router-link :to="{name:'Home'}">Home</router-link>
                    <router-link :to="{name:'Offering'}">What we do</router-link>
                    <router-link :to="{name:'Clients'}">Our Clients</router-link>
                    <router-link :to="{name:'Home'}">Awards</router-link>
                </div>
                <div class="flex flex-col items-end justify-center">
                    <h1 class="text-2xl font-medium w-full">Address</h1>
                    <p class=" my-12 w-full text-left">
                        Kantari, May Ziadeh St. <br>
                        Antwort bldg. <br>
                        Beirut, Lebanon
                    </p>
                    <div class="flex w-full  items-center gap-4" id="social">
                        <a target="_blank" href="https://www.facebook.com/brandmintdesign">
                            <svg id="Component_387_1" data-name="Component 387 – 1" xmlns="http://www.w3.org/2000/svg" width="22.66" height="41.106" viewBox="0 0 22.66 41.106">
                        ...
                        <a target="_blank" href="https://www.instagram.com/brandmint/">
                            <svg id="Component_388_1" data-name="Component 388 – 1" xmlns="http://www.w3.org/2000/svg" width="40.827" height="40.852" viewBox="0 0 40.827 40.852">
                        ...
                        <a target="_blank" href="https://www.linkedin.com/company/brandmint-design-agency/about/">
