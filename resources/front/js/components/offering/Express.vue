<template>
    <p class="text-3xl leading-loose py-12 font-regular">Mint
        Express recognizes that today, more than ever,<b><span> start-ups</span></b><span> are under pressure to be agile and up and running in no time. As our specially formulated fast-lane solution, Mint Express gives</span><b><span> entrepreneurs</span></b><span> the foundations they need to launch their businesses, regardless of how big they are or what stage they’re at, in the shortest space of time.</span>
    </p>
    <div class="grid grid-cols-2 gap-8 py-12">
        <div v-for="block in blocks">
            <p v-html="block.icon"></p>
            <h1 class="my-6 font-bold text-primary text-2xl">{{ block.title }}</h1>
            <p class="text-lg">{{ block.desc }}</p>
        </div>
    </div>
</template>
...
const blocks = [
    {
        ...
        desc: "We start out by surveying every aspect that impacts your brand, from within it to beyond it, allowing us to identify the needs and opportunities.\n",
        icon: `
<svg xmlns="http://www.w3.org/2000/svg" class="w-12" viewBox="0 0 47.406 53.839">
...
`,
    ...
    {
        title: "Fast & Efficient\n",
        desc: "With your brand personality identified, we get to work on pinpointing your brand’s essential visual attributes and tone of voice, to empower all your communications.\n",
        icon: `

<svg xmlns="http://www.w3.org/2000/svg" class="w-14" viewBox="0 0 58.611 60.976">
